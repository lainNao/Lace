...
export const CellViewer = ({
  ...
  if (cell.type === CellDataType.Markdown) {
    return (
      <div className={`${className} ${withLiPrefix ? "custom-li-prefix flex" : ""} `}>
        <details onMouseEnter={(e) => onMouseMainCell(e, cell)}  className={`${withBackgroundHoveredColor && "hover:bg-gray-800"} ${withLiPrefix ? "ml-1" : "" } rounded-b-lg rounded-tr-lg`}>
  ...
  if (cell.type === CellDataType.Sound) {
    return (
      <div  className={`${className} ${withLiPrefix ? "custom-li-prefix flex" : ""} `}>
        <details onMouseEnter={(e) => onMouseMainCell(e, cell)}  className={`${withBackgroundHoveredColor && "hover:bg-gray-800"} ${withLiPrefix ? "ml-1" : "" } rounded-b-lg rounded-tr-lg`} onToggle={onSoundCellToggle} data-is-opening={false}>
  ...
  if (cell.type === CellDataType.Image) {
    return (
      <div  className={`${className} ${withLiPrefix ? "custom-li-prefix flex" : ""} `}>
        <details onMouseEnter={(e) => onMouseMainCell(e, cell)}  className={`${withBackgroundHoveredColor && "hover:bg-gray-800"} ${withLiPrefix ? "ml-1" : "" } rounded-b-lg rounded-tr-lg`} data-is-opening={false}>
  ...
  if (cell.type === CellDataType.Video) {
    return (
      <div  className={`${className} ${withLiPrefix ? "custom-li-prefix flex" : ""} `}>
        <details onMouseEnter={(e) => onMouseMainCell(e, cell)} className={`${withBackgroundHoveredColor && "hover:bg-gray-800"} ${withLiPrefix ? "ml-1" : "" } rounded-b-lg rounded-tr-lg`} onToggle={onVideoCellToggle} data-is-opening={false}>
