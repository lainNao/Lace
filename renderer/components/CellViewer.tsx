...
export const CellViewer = ({
    ...
    return (
      <div>
        <span
          ...
          className={`${className} ${withLiPrefix ? "custom-li-prefix" : ""} ${pointer && "cursor-pointer"} ${(withBackgroundHoveredColor && !highLighted) && "hover:bg-gray-800"} ${highLighted && "bg-yellow-700"} rounded`}
        >
  ...
  if (cell.type === CellDataType.Markdown) {
    return (
      <div className={`${className} ${withLiPrefix ? "custom-li-prefix flex" : ""} `}>
        <details onMouseDown={(e) => onClickMainCell(e, cell)}  className={`${(withBackgroundHoveredColor && !highLighted) && "hover:bg-gray-800"} ${withLiPrefix ? "ml-1" : "" }  ${highLighted && "bg-yellow-700"}  rounded-b-lg rounded-tr-lg rounded`}>
  ...
  if (cell.type === CellDataType.Sound) {
    return (
      <div  className={`${className} ${withLiPrefix ? "custom-li-prefix flex" : ""} `}>
        <details onMouseDown={(e) => onClickMainCell(e, cell)}  className={`${(withBackgroundHoveredColor && !highLighted) && "hover:bg-gray-800"} ${withLiPrefix ? "ml-1" : "" }  ${highLighted && "bg-yellow-700"}  rounded-b-lg rounded-tr-lg rounded`} onToggle={onSoundCellToggle} data-is-opening={false}>
  ...
  if (cell.type === CellDataType.Image) {
    return (
      <div  className={`${className} ${withLiPrefix ? "custom-li-prefix flex" : ""} `}>
        <details onMouseDown={(e) => onClickMainCell(e, cell)}  className={`${(withBackgroundHoveredColor && !highLighted) && "hover:bg-gray-800"} ${withLiPrefix ? "ml-1" : "" }  ${highLighted && "bg-yellow-700"}  rounded-b-lg rounded-tr-lg rounded`} data-is-opening={false}>
  ...
  if (cell.type === CellDataType.Video) {
    return (
      <div  className={`${className} ${withLiPrefix ? "custom-li-prefix flex" : ""} `}>
        <details onMouseDown={(e) => onClickMainCell(e, cell)} className={`${(withBackgroundHoveredColor && !highLighted) && "hover:bg-gray-800"} ${withLiPrefix ? "ml-1" : "" }  ${highLighted && "bg-yellow-700"}  rounded-b-lg rounded-tr-lg rounded`} onToggle={onVideoCellToggle} data-is-opening={false}>
