    ...
    <div className="flex flex-col h-screen">
      ...
      <div className="content flex flex-row w-screen max-h-full ">
        ...
        <div className="flex flex-col items-center p-2 space-y-2.5">
          <Link href="/home"><IconButton aria-label="search" icon={<HomeIcon className="text-blue-400" />} /></Link>
          <Link href="/settings"><IconButton aria-label="edit" icon={<CogIcon className="" />}/></Link>
        </div>
